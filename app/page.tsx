...
export default async function Home() {
  ...
  const featuredReviews = [
    {
      ...
      category: 'Books',
      rating: 5,
      image: 'foundation.jpg', // Image in CDN root
    },
    {
  ...
  return (
    <div className="relative">
      ...
      {/* Featured Content */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#1a2332] border-t border-[#c9d1d9]/20">
        <div className="max-w-7xl mx-auto">
          <h2
            className="text-3xl sm:text-4xl font-normal text-center mb-12 text-[#ff6b35]"
            style={{ fontFamily: 'var(--font-audiowide)' }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredReviews.map((review, index) => (
              ...
              >
                {review.image && (
                  <div className="relative aspect-[4/3] overflow-hidden bg-black border-4 border-[#c9d1d9]">
                    <GalleryImage
