        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <span className="text-[#c9d1d9]/50 cursor-not-allowed">
                  Contact <span className="text-[#c9d1d9]/60 text-xs">(Coming Soon)</span>
                </span>
              </li>
              <li>
                <span className="text-[#c9d1d9]/50 cursor-not-allowed">
                  Privacy Policy <span className="text-[#c9d1d9]/60 text-xs">(Coming Soon)</span>
                </span>
              </li>
              <li>
                <span className="text-[#c9d1d9]/50 cursor-not-allowed">
                  Affiliate Disclosure <span className="text-[#c9d1d9]/60 text-xs">(Coming Soon)</span>
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <span
                className="text-[#c9d1d9]/50 cursor-not-allowed"
