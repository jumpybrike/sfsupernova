...
async function addImage() {
  console.log('🚀 Adding wheel.jpg to gallery...\n')
  ...
  const imageData = {
    ...
    artist: 'Unknown',
    source_url: 'https://cdn.networklayer.co.uk/SFSupernova/siteimages/wheel.jpg',
    license_info: 'Public Domain',
    file_path: 'wheel.jpg',
    thumbnail_path: 'wheel.jpg',
    theme_tags: ['space', 'wheel', 'station']
  }
  ...
  console.log('🖼️  Full URL: https://cdn.networklayer.co.uk/SFSupernova/siteimages/wheel.jpg')
}
